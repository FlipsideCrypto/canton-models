{{ config(
    ...
    unique_key = ['effective_at', 'migration_id', 'event_id', 'party'],
...
SELECT
    ...
    balance_change_array[1]:changeToHoldingFeesRate::NUMBER(38,10) AS change_to_holding_fees_rate,
    balance_change_array[1]:changeToInitialAmountAsOfRoundZero::NUMBER(38,10) AS change_to_initial_amount,
